...
//Delegado con 2 parametros(para que funcione, comenta el codigo arriba con 1 parametro):
...
#region Action
Action<string, string> showMessage = (message1, message2) =>
    {
...
public class Functions
{
    ...
    public static void SomeAction(string name, string lastName, Action<string, string> fn)
    {
        Console.WriteLine("El secreto es");
        fn("Hola", "Bye");
        Console.WriteLine("Finalmente confesado");
